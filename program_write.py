...
# htmlの生成
f = open('/home/pi/programs/html/index.html','w')
f.write(
    '    <!DOCTYPE html>\n'
    '<html lang="ja">\n'
    '\n'
    ...
    '            <div class="co2_box">\n'
    '                <h4 class="co2">CO2</h4>\n'
    '                <div class="graph_co2"><span><h5 class="co2">' + str(data3) + '</h5><h6 class="co2">ppm</h6></span></div>\n'
    '            </div>   \n'
    '            <div class="temp_box">\n'
    '                <h4 class="temp">Temperature</h4>\n'
    '                <div class="graph_temp"><span><h5 class="temp">' + str(data1) + '</h5><h6 class="temp">℃</h6></span></div>\n'
    '            </div>\n'
    '            <div class="hum_box">\n'
    '                <h4 class="humidity">Humidity</h4>\n'
    '                <div class="graph_humidity"><span><h5 class="humidity">' + str(data2) + '</h5><h6 class="humidity">%</h6></span></div>\n'
    '            </div>\n'
    '        </div>\n'
    '        <div class="bottom">\n'
...
# cssの生成
f = open('/home/pi/programs/html/style.css','w')
f.write(
    '.graph_co2 {\n'
	'background-image: radial-gradient(#f2f2f2 50%, transparent 31%), conic-gradient(#25A31D 0%' + str(rate3) + '%, #d9d9d9 ' + str(rate3) + '% 100%);\n'
    '\n'
    '}\n'
    '.graph_temp {\n'
	'background-image: radial-gradient(#f2f2f2 50%, transparent 31%), conic-gradient(#FF9933 0%' + str(rate1) + '%, #d9d9d9 ' + str(rate1) + '% 100%);\n'
    '}\n'
    '\n'
    '.graph_humidity {\n'
	'background-image: radial-gradient(#f2f2f2 50%, transparent 31%), conic-gradient(#457FD3 0%' + str(rate2) + '%, #d9d9d9 ' + str(rate2) + '% 100%);\n'
    '}\n'
)
f.close()